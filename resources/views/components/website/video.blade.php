<section class="py-7 md:py-16 bg-white shadow relative z-10">
    <div class="container">
        ...
        <div class="flex items-center space-y-10 md:space-y-0 md:space-x-10 flex-col md:flex-row">
            ...
            <div class="w-full md:w-1/2">
                <!-- VIDEO DE YOUTUBE -->
                <iframe class="w-full aspect-video" src="https://www.youtube.com/embed/nnMRaegWIrI?si=lwJYdJkKkYpTbFjW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
    </div>
</section>